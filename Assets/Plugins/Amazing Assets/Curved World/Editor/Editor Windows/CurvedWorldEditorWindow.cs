    ...
    namespace CurvedWorldEditor
    {
        public class CurvedWorldEditorWindow : EditorWindow
        {
            ...
            void DrawTab_Manage()
            {
                ...
                else
                {
                    ...
                    using (new AmazingAssets.EditorGUIUtility.EditorGUILayoutBeginVertical(EditorStyles.helpBox))
                    {
                        using (new AmazingAssets.EditorGUIUtility.EditorGUILayoutBeginHorizontal())
                        {
                            EditorGUILayout.TextField("Bend Type", EditorUtilities.shaderKeywordPrefix_BendType + gBendType.ToString().ToUpper());
                            ...
                            using (new AmazingAssets.EditorGUIUtility.GUIBackgroundColor(GUI.skin.settings.selectionColor))
                            {
                                ...
                                {
                                    TextEditor te = new TextEditor();
                                    te.text = EditorUtilities.shaderKeywordPrefix_BendType + gBendType.ToString().ToUpper();
                                    te.SelectAll();
                                    te.Copy();
                                }
                            }
                    ...
                    using (new AmazingAssets.EditorGUIUtility.EditorGUILayoutBeginVertical(EditorStyles.helpBox))
                    {
                        ...
                        using (new AmazingAssets.EditorGUIUtility.EditorGUILayoutBeginHorizontal())
                        {
                            ...
                            using (new AmazingAssets.EditorGUIUtility.GUIBackgroundColor(GUI.skin.settings.selectionColor))
                            {
                                ...
                                {
                                    TextEditor te = new TextEditor();
                                    te.text = "#define " + EditorUtilities.shaderKeywordPrefix_BendType + (gBendType).ToString().ToUpper();
            ...
            void GenerateCoreTransformFile()
            {
                ...
                {
                    if ((int)bendType == 0)
                        file.Add("#if defined (" + EditorUtilities.shaderKeywordPrefix_BendType + bendType.ToString().ToUpper() + ")");
                    else
                        file.Add("#elif defined (" + EditorUtilities.shaderKeywordPrefix_BendType + bendType.ToString().ToUpper() + ")");
