...
namespace Shapes {
	...
	public static class MenuItems {
		...
		public static void CreateDisc( MenuCommand menuCommand ) => CreateShape<Disc>( menuCommand, "Disc", x => x.Type = Disc.DiscType.Disc );
		...
		public static void CreateCircleSector( MenuCommand menuCommand ) => CreateShape<Disc>( menuCommand, "Circular Sector", x => x.Type = Disc.DiscType.Pie );
		...
		public static void CreateAnnulus( MenuCommand menuCommand ) => CreateShape<Disc>( menuCommand, "Ring", x => x.Type = Disc.DiscType.Ring );
		...
		public static void CreateAnnulusSector( MenuCommand menuCommand ) => CreateShape<Disc>( menuCommand, "Arc", x => x.Type = Disc.DiscType.Arc );
