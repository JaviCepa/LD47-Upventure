...
namespace PlatformerPro
{
	...
	public class GroundMovement_SimpleLand : GroundMovement
	{
		...
		/// <summary>
		/// The minimum speed for land.
		/// </summary>
		public float minSpeedForLand;
		...
		/// <summary>
		/// The index for min speed for land.
		/// </summary>
		protected const int  MinSpeedForLandIndex = 2;
		...
		/// <summary>
		/// Default minimum speed for land.
		/// </summary>
		protected const float DefaultMinSpeedForLand = -2.0f;
		...
		override public Movement Init(Character character, MovementVariable[] movementData)
		{
			...
			if (movementData != null && movementData.Length >= MovementVariableCount)
			{
				...
				minSpeedForLand = movementData[MinSpeedForLandIndex].FloatValue;
			}
		...
		public static MovementVariable[] DrawInspector(MovementVariable[] movementData, ref bool showDetails, Character target)
		{
			...
			movementData[MinSpeedForLandIndex].FloatValue = EditorGUILayout.FloatField(new GUIContent("Min Speed for Land", "Speed required before land triggers (negative)"), movementData[MinSpeedForLandIndex].FloatValue);
			if (movementData[MinSpeedForLandIndex].FloatValue > 0) movementData[MinSpeedForLandIndex].FloatValue = 0.0f;
