...
namespace PlatformerPro
{
	...
	public class GroundMovement_CrouchWithSlideAndCrawl : GroundMovement_CrouchWithSlide
	{
		...
		/// </summary>
		protected const int CrawlSpeedIndex = 13;

		/// <summary>
		/// The size of the movement variable array.
		/// </summary>
		new protected const int MovementVariableCount = 14;
		...
		new public static MovementVariable[] DrawInspector(MovementVariable[] movementData, ref bool showDetails, Character target)
		{
			...
			{
				Debug.LogWarning("Upgrading Crouch With Crawl and Slide movement data. Double check new values.");
