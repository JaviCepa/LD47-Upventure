...
namespace PlatformerPro
{
	...
	public class ItemTypeAttributeDrawer : PropertyDrawer
	{
        ...
        public static string DrawItemTypeSelector(Rect position, string currentValue, GUIContent label,
            bool allowNone = false)
        {
            if (ItemTypeManager.Instance == null)
            {
                Debug.LogWarning("Can't edit item types as you don't have an ItemTypeManager in your scene");
                return currentValue;
            }
