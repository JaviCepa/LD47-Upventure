...
namespace PlatformerPro
{
	...
	public class PowerUpManagerInspector : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			myTarget.ignoreZeroValuedMultipliers = EditorGUILayout.Toggle("Ignore Zero Valued Multipliers", myTarget.ignoreZeroValuedMultipliers);
			...
			GUILayout.Label("PowerUp Responses", EditorStyles.boldLabel);
		...
		virtual protected void RenderResponse (PowerUpResponse response) {
			...
			if (responseVisibility[response])
			{
				...
				if (itemData != null) Debug.Log("Duration: " + itemData.effectDuration);
