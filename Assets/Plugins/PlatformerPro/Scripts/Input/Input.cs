...
namespace PlatformerPro
{
	...
	public abstract class Input : PlatformerProMonoBehaviour
	{
		...
		/// </summary>
		virtual public void ConsumeJumpButton()
		{
			Debug.LogError("ConsumeJumpButton is not implemented by this input");
		}

		/// <summary>
		/// Consumes a run button down event converting it in to a button held event. Does nothing if the button is in another state.
		/// </summary>
		virtual public void ConsumeRunButton() 
		{
			Debug.LogError("ConsumeRunButton is not implemented by this input");	
		}
		...
		/// </summary>
		virtual public void ConsumeActionButton(int index)
		{
			Debug.LogError("ConsumeActionButton is not implemented by this input");
		}
