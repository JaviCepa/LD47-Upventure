...
namespace PlatformerPro
{
	...
	public class DamageAfterTimePlatform : ParentOnStandPlatform
	{
		...
		/// <summary>
		/// If true the damage timer will start again after damage triggers.
		/// </summary>
		public bool damageRepeats = false;
		...
		virtual protected IEnumerator DamageCharacter(IMob character)
		{
			...
			else
			{
				...
				if (character is Enemy)
				{
					...
					if (damageRepeats) StartCoroutine (DamageCharacter (character));
				}
				else
				{
