...
namespace PlatformerPro
{
	...
	public class Door : Platform
	{
		...
		/// </summary>
		[Tooltip ("Facing direction for generated respawn point.")]
		[DontShowWhen("generateRespawnPoint", true)]
		[Range (-1,1)]
		public int respawnFacingDirection;
		...
		override protected void PostInit() 
		{
			...
			if (generateRespawnPoint)
			{
                ...
                respawnPoint.facingDirection = respawnFacingDirection;
