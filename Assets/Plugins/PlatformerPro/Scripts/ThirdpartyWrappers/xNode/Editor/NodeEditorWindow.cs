...
namespace XNodeEditor {
    ...
    public partial class NodeEditorWindow : EditorWindow {
        ...
        public static NodeEditorWindow Open(XNode.NodeGraph graph) {
            ...
            NodeEditorWindow w = GetWindow(typeof(NodeEditorWindow), false, GetTitle(graph), true) as NodeEditorWindow;
            w.wantsMouseMove = true;
            w.graph = graph;
            w.titleContent = new GUIContent(GetTitle(graph));
            return w;
        }
        ...
        public static string GetTitle(XNode.NodeGraph graph) {
            string windowTitle = graph.GetType().Name.Replace("Graph", "") + " Editor";
            return windowTitle;
        }
    }
}
