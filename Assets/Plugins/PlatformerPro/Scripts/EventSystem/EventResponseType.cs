namespace PlatformerPro
{
	...
	public static class EventResponseExtensions {
		public static string GetName(this EventResponseType me) {
			...
			case EventResponseType.DISABLE_BEHAVIOUR: return "Activation/Disable Behaviour";
			case EventResponseType.ACTIVATE_PLATFORM: return "Activation/Activate Platform";
			case EventResponseType.DEACTIVATE_PLATFORM: return "Activation/Deactivate Platform";
			...
			case EventResponseType.SHOW_DIALOG: return "Dialog/Show Dialog";
			
			case EventResponseType.SWITCH_CAMERA_ZONE: return "Camera/Switch Camera Zone";
			
			case EventResponseType.ENEMY_MESSAGE: return "Enemy/Send Message";
