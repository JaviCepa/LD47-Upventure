...
namespace PlatformerPro
{
	...
	public class ProjectileAimer : MonoBehaviour
	{
		...
		/// </summary>
		[Tooltip("If true the projectile offset flips with direction change. If false it doesn't.")]
		public bool flipOffsets = true;
		...
		virtual public Vector2 GetAimOffset(IMob character)
		{
			...
			if (flipOffsets && character.LastFacedDirection == -1) return new Vector2(-offset.x, offset.y);
			return offset;
		}
