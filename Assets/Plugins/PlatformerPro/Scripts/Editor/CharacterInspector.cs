...
namespace PlatformerPro
{
	...
	public class CharacterInspector : Editor
	{
		...
		protected SerializedProperty snapToGroundOnSlopesOnly;
		...
		void OnEnable()
		{
			...
			snapToGroundOnSlopesOnly = serializedObject.FindProperty("snapToGroundOnSlopesOnly");
		...
		public override void OnInspectorGUI()
		{
			...
			PlatformerProMonoBehaviourInspector.DrawHeaderStatic((Character)target);
		...
		virtual protected void DrawAvancedSettingsFoldout()
		{
			...
			if(advancedFoldOut)
			{
				...
				if (GUILayout.Button(new GUIContent("Reset To Defaults","Resets all advanced settings to default values.")))
				{
					...
					snapToGroundOnSlopesOnly.boolValue = true;
				...
				EditorGUILayout.PropertyField(snapToGroundOnSlopesOnly, new GUIContent("Snap Only on Slopes", "If true the snap to ground method used in many ground movements will only apply on slopes."));
		...
		{
			PlatformerProMonoBehaviourInspector.DrawHorizontalRule();
        ...
        {
            PlatformerProMonoBehaviourInspector.DrawHorizontalRule();
            GUILayout.Label("Configuration Validation", EditorStyles.boldLabel);
            if (validateSettings)
            { 
                ...
                {
	                EditorGUILayout.HelpBox("No validation errors found. \n\nNote: Only active GameObjects are validated.", MessageType.None);
                }
                else
                {
